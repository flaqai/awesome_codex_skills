...
> تحت صيانة [Flaq.ai](https://flaq.ai) — منصة إبداع AI-native لتوليد الصور والفيديو والدردشة.
...
- [لماذا هذه القائمة](#لماذا-هذه-القائمة)
...
- [مشاريع مفتوحة المصدر موصى بها](#مشاريع-مفتوحة-المصدر-موصى-بها)
...
- [أدوات الوكلاء](#أدوات-الوكلاء) - مهارات أساسية تساعد Codex على العثور على Skills أخرى أو تركيبها أو إنشائها.
- [البرمجة والواجهات الأمامية](#البرمجة-والواجهات-الأمامية) - مهارات للواجهات الأمامية وواجهة المستخدم والنشر وفهم المستودعات وسير العمل الهندسي.
- [الإبداع والوسائط](#الإبداع-والوسائط) - مهارات إبداعية للصور والصوت والفيديو والمواد التسويقية وإنتاج الوسائط.
- [أتمتة المتصفح والاختبار](#أتمتة-المتصفح-والاختبار) - مهارات للتحكم في المتصفح ولقطات الشاشة وفحص الواجهة والتحقق من التفاعل.
- [المستندات والعروض](#المستندات-والعروض) - مهارات لملفات PDF والشرائح والتقارير والمقترحات والمستندات المنظمة.
- [البيانات والتصور](#البيانات-والتصور) - مهارات للرسوم البيانية والشرح المرئي والتحليلات والسرد المعتمد على البيانات.
- [التسويق والنمو](#التسويق-والنمو) - مهارات لتحسين SEO وكتابة النصوص ومواد الإطلاق والحملات وسير عمل النمو.
- [الصناعات والامتثال](#الصناعات-والامتثال) - مهارات متخصصة للرعاية الصحية وإمكانية الوصول والأمان والتوطين ومجالات أخرى.
...
- **[Find Skills](https://orangebot.ai/s/find-skills)**  
  أداة اكتشاف تساعد Codex على العثور على Skills مفيدة ومقارنتها واختيارها في بداية المهمة.  
  الوسوم: `AI Agent` `Discovery` `Tooling`  
  المصدر: OrangeBot · الشعبية: 751.5k weekly installs, 6,390 stars, 707 forks on OrangeBot.  
  ملاحظات: مناسب كنقطة دخول مثبتة مسبقًا لاستكشاف المزيد من Skills.
...
- **[Vercel React Best Practices](https://orangebot.ai/s/vercel-react-best-practices)**  
  دليل React/Vercel لبناء بنية تطبيق ومكوّنات وتوجيه ونشر وأداء يسهل صيانتها.  
  الوسوم: `React` `Vercel` `Frontend`  
  المصدر: OrangeBot · الشعبية: 256.2k weekly installs, 3,285 stars, 495 forks on OrangeBot.

- **[Frontend Design](https://orangebot.ai/s/frontend-design)**  
  يساعد Codex على تخطيط واجهات مصقولة قبل التنفيذ، بما في ذلك التسلسل والتخطيط وحالات المكوّنات والاستجابة.  
  الوسوم: `Frontend` `UI/UX` `Design`  
  المصدر: OrangeBot · الشعبية: 211.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[ShadCN](https://ui.shadcn.com/docs/skills)**  
  إرشادات رسمية لإنشاء مكوّنات React حديثة ولوحات معلومات ونماذج وحوارات وواجهات أدوات.  
  الوسوم: `React` `Components` `UI`  
  المصدر: ShadCN Docs · الشعبية: Official ShadCN skills/rules entry for a high-star mainstream React component ecosystem.

- **[AI Image Generation](https://orangebot.ai/s/ai-image-generation)**  
  مهارة إبداعية للصور للملصقات والمفاهيم ومرئيات المنتجات والإعلانات والأغلفة ومواد التواصل ومراجع التصميم.  
  الوسوم: `Image` `Creative` `Marketing`  
  المصدر: OrangeBot · الشعبية: 113.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.  
  ملاحظات: راجع متطلبات النموذج/API قبل التثبيت المسبق.
...
- **[Agent Browser](https://orangebot.ai/s/agent-browser)**  
  يمكّن Codex من فتح الصفحات والنقر والتقاط الصور وفحص الواجهة والتحقق من التفاعلات.  
  الوسوم: `Browser` `Automation` `Testing`  
  المصدر: OrangeBot · الشعبية: 136.6k weekly installs, 29,773 stars, 3,154 forks on OrangeBot.

- **[Playwright](https://github.com/openai/skills/tree/main/skills/.curated/playwright)**  
  مهارة رسمية لأتمتة المتصفح للتنقل ولقطات الشاشة وفحص التخطيط والتحقق من التفاعلات.  
  الوسوم: `Playwright` `Testing` `Browser`  
...
- **[PDF](https://orangebot.ai/s/pdf)**  
  يقرأ وينشئ ويعرض ويفحص ملفات PDF بصريًا للتقارير والمقترحات والأدلة والمواد التعليمية.  
  الوسوم: `PDF` `Documents` `Reports`  
  المصدر: OrangeBot · الشعبية: 53.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[Security Best Practices](https://github.com/openai/skills/tree/main/skills/.curated/security-best-practices)**  
  يرشد Codex لمراعاة المصادقة والصلاحيات والأسرار والتحقق من الإدخال ومخاطر التبعيات وأمان الشبكة.  
...
مهارات أساسية تساعد Codex على العثور على Skills أخرى أو تركيبها أو إنشائها.
...
مهارات للواجهات الأمامية وواجهة المستخدم والنشر وفهم المستودعات وسير العمل الهندسي.
...
- **[Vercel Deploy](https://github.com/openai/skills/tree/main/skills/.curated/vercel-deploy)**  
  يساعد Codex على نشر تطبيقات الواجهة الأمامية ومواقع الأدوات والنماذج على Vercel.  
  الوسوم: `Deployment` `Vercel` `DevOps`  
  المصدر: GitHub openai/skills · الشعبية: Official OpenAI curated skill from the openai/skills repository.

- **[Repo Story Time](https://orangebot.ai/s/repo-story-time)**  
  يشرح قواعد الكود والبنية الهندسية وتاريخ التغييرات والسرد التقني بطريقة سهلة القراءة.  
...
- **[P Video](https://orangebot.ai/s/p-video)**  
  ...
  الوسوم: `Video` `Shorts` `Media`  
  المصدر: OrangeBot · الشعبية: 108.7k weekly installs, 5,102 stars, 478 forks on OrangeBot.

- **[ElevenLabs Music](https://orangebot.ai/s/elevenlabs-music)**  
  مهارة موسيقى/صوت لأفكار الموسيقى الخلفية في الأفلام القصيرة والإعلانات ونماذج الألعاب والدورات والمحتوى الاجتماعي.  
  الوسوم: `Music` `Audio` `Creative`  
  المصدر: OrangeBot · الشعبية: 51.7k weekly installs, 144 stars, 31 forks on OrangeBot.  
  ملاحظات: يتطلب عادةً إعداد خدمة خارجية.
...
مهارات للتحكم في المتصفح ولقطات الشاشة وفحص الواجهة والتحقق من التفاعل.
...
- **[Screenshot](https://github.com/openai/skills/tree/main/skills/.curated/screenshot)**  
  يحوّل مخرجات الواجهة إلى لقطات شاشة قابلة للفحص ويساعد في كشف مشاكل التخطيط والمظهر والاستجابة والتداخل.  
...
- **[PPTX](https://orangebot.ai/s/pptx)**  
  ينشئ أو يحرر عروضًا تقديمية لعرض المنتجات والدروس وخطط التسويق وتقارير الشركات.  
  الوسوم: `Slides` `Presentations` `Documents`  
  المصدر: OrangeBot · الشعبية: 48.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[DOCX](https://orangebot.ai/s/docx)**  
  ينشئ ويحرر وينسق ويراجع ويصدر مستندات Word للتقارير والخطط والأدلة وسير العمل المؤسسي.  
...
مهارات لتحسين SEO وكتابة النصوص ومواد الإطلاق والحملات وسير عمل النمو.

- **[App Store Screenshots](https://orangebot.ai/s/app-store-screenshots)**  
  يساعد في إنشاء لقطات شاشة المنتج ورسومات الترويج ومواد الإطلاق ومعاينات التواصل ومرئيات الحملات.  
  الوسوم: `Marketing` `Screenshots` `Launch`  
  المصدر: OrangeBot · الشعبية: OrangeBot skill page with usage, stars, and forks metadata.

- **[Awesome SEO Writing Skill](https://github.com/flaqai/Awesome_SEO_Writing_Skill)**  
  يحوّل موجز المحتوى إلى سير عمل SEO يشمل التخطيط والكتابة والتحقق من الحقائق والتدقيق وتجهيز الصور والتسليم الاختياري عبر Cloudflare R2.  
  الوسوم: `SEO` `Writing` `Content`  
  المصدر: GitHub flaqai/Awesome_SEO_Writing_Skill · الشعبية: مستودع مفتوح المصدر بوثائق متعددة اللغات وسير عمل writer قابل لإعادة الاستخدام مع Codex وClaude Code.

- **[SEO Audit](https://orangebot.ai/s/seo-audit)**  
  يفحص بنية الصفحة والعناوين وجودة المحتوى والفهرسة وSEO التقني وفرص التحسين.  
  الوسوم: `SEO` `Marketing` `Content`  
  المصدر: OrangeBot · الشعبية: 57.8k weekly installs, 6,390 stars, 707 forks on OrangeBot.
...
مهارات متخصصة للرعاية الصحية وإمكانية الوصول والأمان والتوطين ومجالات أخرى.

- **[Translate](https://skillmd.ai/skills/translate/)**  
  يترجم المحتوى متعدد اللغات ويوطّن المستندات ونصوص المنتجات ومواد التجارة الإلكترونية العابرة للحدود.  
  الوسوم: `Localization` `Documents` `Ecommerce`  
  المصدر: SkillMD.ai · الشعبية: 4,268 views and 1,828 downloads on SkillMD.ai.

- **[Accessibility Compliance](https://orangebot.ai/s/accessibility-compliance)**  
  يحسّن إمكانية الوصول عبر الدلالات والتباين والتنقل بلوحة المفاتيح وARIA ومراجعة UX.  
  الوسوم: `Accessibility` `Compliance` `Frontend`  
  المصدر: OrangeBot · الشعبية: OrangeBot skill page with usage, stars, and forks metadata.
...
- **[OpenClaw Medical Skills](https://skills.cat/skills/yuan1z0825/nature-skills/openclaw-medical-skills)**  
  مهارة صحية للمعرفة الطبية والنصوص السريرية وتحليل البيانات الطبية أو دعم سير العمل الصحي.  
  الوسوم: `Healthcare` `Medical` `Compliance`  
...
يصدر هذا المستودع وفق ترخيصه. أسماء Skills والمحتوى المرتبط تعود إلى مالكيها.

## شكر وتقدير

شكرًا لبناة أدلة Skills ومشرفي open-source ومجتمع Codex الذين يجعلون سير عمل Agent القابلة لإعادة الاستخدام أسهل اكتشافًا.

## مشاريع مفتوحة المصدر موصى بها
