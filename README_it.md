...
> Mantenuto da [Flaq.ai](https://flaq.ai) — piattaforma creativa AI-native per generazione di immagini, video e chat.
...
- [Perché questa lista](#perché-questa-lista)
...
- [Strumenti Agent](#strumenti-agent) - Skill di base che aiutano Codex a trovare, combinare o creare altri Skill.
- [Sviluppo e frontend](#sviluppo-e-frontend) - Skill per frontend, UI, deploy, comprensione dei repository e workflow tecnici.
- [Creatività e media](#creatività-e-media) - Skill creativi per immagini, audio, video, visual marketing e produzione media.
- [Automazione browser e test](#automazione-browser-e-test) - Skill per controllo browser, screenshot, controlli UI e validazione delle interazioni.
- [Documenti e presentazioni](#documenti-e-presentazioni) - Skill per PDF, slide, report, proposte e documenti strutturati.
- [Dati e visualizzazione](#dati-e-visualizzazione) - Skill per grafici, spiegazioni visuali, analisi e narrazioni basate sui dati.
- [Marketing e crescita](#marketing-e-crescita) - Skill per SEO, copy, asset di lancio, campagne e workflow di crescita.
- [Settori e conformità](#settori-e-conformità) - Skill verticali per sanità, accessibilità, sicurezza, localizzazione e altri domini.
...
- **[Find Skills](https://orangebot.ai/s/find-skills)**  
  Strumento di scoperta che aiuta Codex a trovare, confrontare e scegliere Skill utili all’inizio di un’attività.  
  Tag: `AI Agent` `Discovery` `Tooling`  
  Fonte: OrangeBot · Popolarità: 751.5k weekly installs, 6,390 stars, 707 forks on OrangeBot.  
  Note: Ottimo punto di ingresso preinstallato per esplorare altri Skill.
...
- **[Vercel React Best Practices](https://orangebot.ai/s/vercel-react-best-practices)**  
  Guida React/Vercel per struttura manutenibile, componenti, routing, deploy e performance.  
  Tag: `React` `Vercel` `Frontend`  
  Fonte: OrangeBot · Popolarità: 256.2k weekly installs, 3,285 stars, 495 forks on OrangeBot.

- **[Frontend Design](https://orangebot.ai/s/frontend-design)**  
  Aiuta Codex a progettare interfacce curate prima dell’implementazione, con gerarchia, layout, stati e responsive.  
  Tag: `Frontend` `UI/UX` `Design`  
  Fonte: OrangeBot · Popolarità: 211.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[ShadCN](https://ui.shadcn.com/docs/skills)**  
  Guida ufficiale per generare componenti React moderni, dashboard, form, dialog e superfici tool.  
  Tag: `React` `Components` `UI`  
  Fonte: ShadCN Docs · Popolarità: Official ShadCN skills/rules entry for a high-star mainstream React component ecosystem.

- **[AI Image Generation](https://orangebot.ai/s/ai-image-generation)**  
  Skill creativo per immagini: poster, concept, visual prodotto, annunci, cover, asset social e riferimenti design.  
  Tag: `Image` `Creative` `Marketing`  
  Fonte: OrangeBot · Popolarità: 113.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.  
  Note: Verificare requisiti modello/API prima della preinstallazione.
...
- **[Agent Browser](https://orangebot.ai/s/agent-browser)**  
  Permette a Codex di aprire pagine, cliccare, fare screenshot, ispezionare UI e validare interazioni.  
  Tag: `Browser` `Automation` `Testing`  
  Fonte: OrangeBot · Popolarità: 136.6k weekly installs, 29,773 stars, 3,154 forks on OrangeBot.

- **[Playwright](https://github.com/openai/skills/tree/main/skills/.curated/playwright)**  
  Skill ufficiale di automazione browser per navigazione, screenshot, controlli layout e validazione interazioni.  
  Tag: `Playwright` `Testing` `Browser`  
...
- **[PDF](https://orangebot.ai/s/pdf)**  
  Legge, crea, renderizza e controlla visivamente PDF per report, proposte, manuali e materiali educativi.  
  Tag: `PDF` `Documents` `Reports`  
  Fonte: OrangeBot · Popolarità: 53.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[Security Best Practices](https://github.com/openai/skills/tree/main/skills/.curated/security-best-practices)**  
  Guida Codex su autenticazione, permessi, segreti, validazione input, rischi dipendenze e sicurezza di rete.  
...
Skill di base che aiutano Codex a trovare, combinare o creare altri Skill.
...
Skill per frontend, UI, deploy, comprensione dei repository e workflow tecnici.
...
- **[Vercel Deploy](https://github.com/openai/skills/tree/main/skills/.curated/vercel-deploy)**  
  Aiuta Codex a distribuire app frontend, siti tool e prototipi su Vercel.  
  Tag: `Deployment` `Vercel` `DevOps`  
  Fonte: GitHub openai/skills · Popolarità: Official OpenAI curated skill from the openai/skills repository.

- **[Repo Story Time](https://orangebot.ai/s/repo-story-time)**  
  Spiega codebase, struttura tecnica, cronologia delle modifiche e narrazioni tecniche in modo leggibile.  
...
- **[P Video](https://orangebot.ai/s/p-video)**  
  ...
  Tag: `Video` `Shorts` `Media`  
  Fonte: OrangeBot · Popolarità: 108.7k weekly installs, 5,102 stars, 478 forks on OrangeBot.

- **[ElevenLabs Music](https://orangebot.ai/s/elevenlabs-music)**  
  Skill musica/audio per idee di musica di sottofondo in corti, annunci, prototipi di gioco, corsi e social.  
  Tag: `Music` `Audio` `Creative`  
  Fonte: OrangeBot · Popolarità: 51.7k weekly installs, 144 stars, 31 forks on OrangeBot.  
  Note: Di solito richiede configurazione di un servizio esterno.
...
Skill per controllo browser, screenshot, controlli UI e validazione delle interazioni.
...
- **[Screenshot](https://github.com/openai/skills/tree/main/skills/.curated/screenshot)**  
  Trasforma output UI in screenshot ispezionabili e aiuta a trovare problemi layout, visual, responsive e sovrapposizione.  
...
- **[PPTX](https://orangebot.ai/s/pptx)**  
  Crea o modifica presentazioni per pitch prodotto, lezioni, piani marketing e report aziendali.  
  Tag: `Slides` `Presentations` `Documents`  
  Fonte: OrangeBot · Popolarità: 48.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[DOCX](https://orangebot.ai/s/docx)**  
  Crea, modifica, formatta, revisiona ed esporta documenti Word per report, piani, manuali e workflow aziendali.  
...
Skill per SEO, copy, asset di lancio, campagne e workflow di crescita.

- **[App Store Screenshots](https://orangebot.ai/s/app-store-screenshots)**  
  Aiuta a creare screenshot prodotto, grafiche promozionali, asset di lancio, preview social e visual campagna.  
  Tag: `Marketing` `Screenshots` `Launch`  
  Fonte: OrangeBot · Popolarità: OrangeBot skill page with usage, stars, and forks metadata.

- **[SEO Audit](https://orangebot.ai/s/seo-audit)**  
  Controlla struttura pagina, titoli, qualità contenuto, indicizzazione, SEO tecnico e opportunità.  
  Tag: `SEO` `Marketing` `Content`  
  Fonte: OrangeBot · Popolarità: 57.8k weekly installs, 6,390 stars, 707 forks on OrangeBot.
...
Skill verticali per sanità, accessibilità, sicurezza, localizzazione e altri domini.

- **[Translate](https://skillmd.ai/skills/translate/)**  
  Traduce contenuti multilingue e localizza documenti, copy prodotto e materiali ecommerce cross-border.  
  Tag: `Localization` `Documents` `Ecommerce`  
  Fonte: SkillMD.ai · Popolarità: 4,268 views and 1,828 downloads on SkillMD.ai.

- **[Accessibility Compliance](https://orangebot.ai/s/accessibility-compliance)**  
  Migliora l’accessibilità tramite semantica, contrasto, navigazione da tastiera, ARIA e review UX.  
  Tag: `Accessibility` `Compliance` `Frontend`  
  Fonte: OrangeBot · Popolarità: OrangeBot skill page with usage, stars, and forks metadata.
...
- **[OpenClaw Medical Skills](https://skills.cat/skills/yuan1z0825/nature-skills/openclaw-medical-skills)**  
  Skill sanitario per conoscenza medica, testi clinici, analisi dati sanitari o supporto workflow salute.  
  Tag: `Healthcare` `Medical` `Compliance`  
...
Questo repository è rilasciato sotto la licenza del repository. Nomi Skill e contenuti collegati appartengono ai rispettivi proprietari.

## Ringraziamenti

Grazie ai creatori di directory Skill, maintainer open-source e community Codex che rendono più scopribili workflow Agent riutilizzabili.
