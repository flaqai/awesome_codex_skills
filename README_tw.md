...
> 由 [Flaq.ai](https://flaq.ai) 維護 — AI 原生創作平台，提供圖像、影片和對話生成服務。
...
- [Agent 工具鏈](#agent-工具鏈) - 幫助 Codex 查找、組合或建立其他 Skill 的基礎能力。
- [程式開發與前端](#程式開發與前端) - 前端、UI、部署、程式庫理解和工程工作流相關 Skill。
- [創作與媒體](#創作與媒體) - 涵蓋圖片、音訊、影片、行銷視覺和媒體製作的創作類 Skill。
- [瀏覽器自動化與測試](#瀏覽器自動化與測試) - 用於瀏覽器控制、截圖、UI 檢查和互動驗證的 Skill。
- [文件與簡報](#文件與簡報) - 用於 PDF、投影片、報告、提案和結構化文件的 Skill。
- [資料與視覺化](#資料與視覺化) - 用於圖表、視覺化說明、資料分析和資料敘事的 Skill。
- [行銷與成長](#行銷與成長) - 用於 SEO、文案、發布素材、活動和成長工作流的 Skill。
- [產業能力與合規](#產業能力與合規) - 醫療、可訪問性、安全、本地化和其他垂直領域 Skill。
...
- **[Find Skills](https://orangebot.ai/s/find-skills)**  
  幫助 Codex 在任務開始時查找、比較並選擇有用 Skill 的發現工具。  
  標籤: `AI Agent` `Discovery` `Tooling`  
  來源: OrangeBot · 熱度: 751.5k weekly installs, 6,390 stars, 707 forks on OrangeBot.  
  注意: 適合作為預裝入口，幫助使用者探索更多 Skill。
...
- **[Vercel React Best Practices](https://orangebot.ai/s/vercel-react-best-practices)**  
  React 與 Vercel 實務指南，協助建立可維護的應用結構、元件、路由、部署與效能。  
  標籤: `React` `Vercel` `Frontend`  
  來源: OrangeBot · 熱度: 256.2k weekly installs, 3,285 stars, 495 forks on OrangeBot.

- **[Frontend Design](https://orangebot.ai/s/frontend-design)**  
  協助 Codex 在實作前規劃精緻介面，包括層級、版面、元件狀態與響應式行為。  
  標籤: `Frontend` `UI/UX` `Design`  
  來源: OrangeBot · 熱度: 211.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[ShadCN](https://ui.shadcn.com/docs/skills)**  
  生成現代 React 元件、儀表板、表單、對話框和工具介面的官方指南。  
  標籤: `React` `Components` `UI`  
  來源: ShadCN Docs · 熱度: Official ShadCN skills/rules entry for a high-star mainstream React component ecosystem.

- **[AI Image Generation](https://orangebot.ai/s/ai-image-generation)**  
  用於海報、概念圖、產品視覺、廣告、封面、社群素材和設計參考的創作圖片 Skill。  
  標籤: `Image` `Creative` `Marketing`  
  來源: OrangeBot · 熱度: 113.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.  
  注意: 預裝前應審查模型/API 要求。
...
- **[Agent Browser](https://orangebot.ai/s/agent-browser)**  
  讓 Codex 開啟頁面、點擊、截圖、檢查 UI 並驗證互動。  
  標籤: `Browser` `Automation` `Testing`  
  來源: OrangeBot · 熱度: 136.6k weekly installs, 29,773 stars, 3,154 forks on OrangeBot.

- **[Playwright](https://github.com/openai/skills/tree/main/skills/.curated/playwright)**  
  官方瀏覽器自動化 Skill，用於頁面導航、截圖、版面檢查和互動驗證。  
  標籤: `Playwright` `Testing` `Browser`  
  來源: GitHub openai/skills · 熱度: Official OpenAI curated skill from the openai/skills repository.

- **[PDF](https://orangebot.ai/s/pdf)**  
  讀取、建立、渲染並視覺檢查 PDF，適合報告、提案、手冊和教育材料。  
  標籤: `PDF` `Documents` `Reports`  
  來源: OrangeBot · 熱度: 53.4k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[Security Best Practices](https://github.com/openai/skills/tree/main/skills/.curated/security-best-practices)**  
  引導 Codex 關注認證、權限、密鑰、輸入驗證、依賴風險和網路安全。  
...
幫助 Codex 查找、組合或建立其他 Skill 的基礎能力。
...
- **[Vercel Deploy](https://github.com/openai/skills/tree/main/skills/.curated/vercel-deploy)**  
  協助 Codex 將前端應用、工具站點和原型部署到 Vercel。  
  標籤: `Deployment` `Vercel` `DevOps`  
  來源: GitHub openai/skills · 熱度: Official OpenAI curated skill from the openai/skills repository.

- **[Repo Story Time](https://orangebot.ai/s/repo-story-time)**  
  以易讀方式解釋程式庫、工程結構、變更歷史和技術脈絡。  
...
- **[P Video](https://orangebot.ai/s/p-video)**  
  ...
  標籤: `Video` `Shorts` `Media`  
  來源: OrangeBot · 熱度: 108.7k weekly installs, 5,102 stars, 478 forks on OrangeBot.

- **[ElevenLabs Music](https://orangebot.ai/s/elevenlabs-music)**  
  為短片、廣告、遊戲原型、課程和社群內容提供背景音樂創意的音樂/音訊 Skill。  
  標籤: `Music` `Audio` `Creative`  
  來源: OrangeBot · 熱度: 51.7k weekly installs, 144 stars, 31 forks on OrangeBot.  
  注意: 通常需要配置外部服務。
...
- **[Screenshot](https://github.com/openai/skills/tree/main/skills/.curated/screenshot)**  
  將 UI 輸出轉為可檢查截圖，協助發現版面、視覺、響應式和遮擋問題。  
...
- **[PPTX](https://orangebot.ai/s/pptx)**  
  建立或編輯簡報交付物，用於產品提案、課程、行銷計畫和企業報告。  
  標籤: `Slides` `Presentations` `Documents`  
  來源: OrangeBot · 熱度: 48.9k weekly installs, 4,938 stars, 353 forks on OrangeBot.

- **[DOCX](https://orangebot.ai/s/docx)**  
  建立、編輯、排版、審閱並匯出 Word 文件，適合報告、計畫、手冊和企業流程。  
...
- **[SEO Audit](https://orangebot.ai/s/seo-audit)**  
  ...
  來源: OrangeBot · 熱度: 57.8k weekly installs, 6,390 stars, 707 forks on OrangeBot.
...
醫療、可訪問性、安全、本地化和其他垂直領域 Skill。

- **[Translate](https://skillmd.ai/skills/translate/)**  
  翻譯多語內容，將文件、產品文案和跨境電商素材本地化。  
  標籤: `Localization` `Documents` `Ecommerce`  
  來源: SkillMD.ai · 熱度: 4,268 views and 1,828 downloads on SkillMD.ai.

- **[Accessibility Compliance](https://orangebot.ai/s/accessibility-compliance)**  
  透過語義、對比度、鍵盤導覽、ARIA 和 UX 審查改進可訪問性。  
  標籤: `Accessibility` `Compliance` `Frontend`  
  來源: OrangeBot · 熱度: OrangeBot skill page with usage, stars, and forks metadata.
...
- **[OpenClaw Medical Skills](https://skills.cat/skills/yuan1z0825/nature-skills/openclaw-medical-skills)**  
  面向醫學知識、臨床文字、醫療資料分析或健康工作流輔助的醫療健康 Skill。  
  標籤: `Healthcare` `Medical` `Compliance`  
...
本倉庫依照倉庫授權發布。Skill 名稱和連結內容歸各自所有者所有。
